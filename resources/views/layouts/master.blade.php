...
<head>
    ...
    @else
        <link rel="stylesheet" href="{{ asset('build/assets/app-DypmRwCW.css') }}">
        <script src="{{ asset('build/assets/app-1UQdrMZs.js') }}" defer></script>
        <script src="{{ asset('build/assets/app-SJsmMwxi.js') }}" defer></script>
    @endif
